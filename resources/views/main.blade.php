        ...
        <div class="card mb-5 mt-3 shadow-lg">
            ...
            <div class="card-body">
                ...
                <p class="card-text">{!! Str::words($blog->description, 10,' >>>' ) !!} <small><a class="text-reset"
                            href="{{ route('resume',[$blog->category,$blog->slug]) }}">devamını oku</a></small>
                        
                            
                            <span style="float: right; ">
                            <a role="button" onclick="like({{$blog->id}})"><i class="fa fa-thumbs-up"
                                ...
                                @endif
                                @endforeach
                                <span style="float: right;" id='count-{{$blog->id}}'>{{$count}}</span>
                            </span>
